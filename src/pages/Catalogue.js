...
const CATEGORIES_FEMME = [
  { label: 'Sacs & Maroquinerie', slug: 'maroquinerie', img: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=1600&q=90', sell: 'Les sacs les plus convoités au monde.' },
  { label: 'Bijoux & Montres',    slug: 'joaillerie',    img: 'https://images.unsplash.com/photo-1635767798595-a1d2c9deacb4?w=1200&q=90', sell: 'Des garde-temps et pièces de collection.' },
  ...
  { label: 'Chaussures',          slug: 'chaussures',    img: 'https://images.unsplash.com/photo-1535043934128-cf0b28d52f95?w=1000&q=90', sell: "Créations d'exception, sourcées en privé." },
  { label: 'Art de vivre',        slug: 'art-de-vivre',  img: 'https://images.unsplash.com/photo-1575027773195-f6c7298430c8?w=1000&q=90', sell: "Ce que personne d'autre ne peut vous trouver." },
];

const CATEGORIES_HOMME = [
  { label: 'Costumes & Tenues',      slug: 'mode',          img: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=1600&q=90', sell: 'Des coupes et matières irréprochables.' },
  { label: 'Montres & Bijoux',       slug: 'joaillerie',    img: 'https://images.unsplash.com/photo-1548169874-53e85f753f1e?w=1200&q=90',   sell: 'Des garde-temps de collection.' },
  { label: 'Chaussures Homme',       slug: 'chaussures',    img: 'https://images.unsplash.com/photo-1552422554-0d5af0c79fc6?w=1000&q=90', sell: "Des pièces qu'on ne retrouve plus en boutique." },
  { label: 'Maroquinerie Homme',     slug: 'maroquinerie', img: 'https://images.unsplash.com/photo-1473188588951-666fce8e7c68?w=1000&q=90', sell: 'Les sacs et cuirs les plus recherchés.' },
  { label: 'Sneakers & Sport',       slug: 'sneakers',      img: 'https://images.unsplash.com/photo-1571601035754-5c927f2d7edc?w=1000&q=90', sell: "Ce que personne d'autre ne peut vous trouver." },
];
...
export default function Home() {
  ...
  const CATEGORIES = genre === 'homme' ? CATEGORIES_HOMME : CATEGORIES_FEMME;
    ...
    <div style={{ background: '#fff', fontFamily: sans }}>
      ...
      <div style={{ position: 'relative', height: '100vh', minHeight: '680px', overflow: 'hidden', background: COLORS.black }}>
        ...
        <div style={{ position: 'absolute', inset: 0, zIndex: 3, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '0 32px' }}>
          ...
          <h1 style={{ fontFamily: sans, fontStyle: 'normal', fontWeight: 300, fontSize: 'clamp(1.05rem, 2vw, 1.35rem)', letterSpacing: '.01em', color: 'rgba(255,255,255,.92)', maxWidth: '520px', width: '100%', boxSizing: 'border-box', lineHeight: 1.6, marginBottom: '36px' }}>
